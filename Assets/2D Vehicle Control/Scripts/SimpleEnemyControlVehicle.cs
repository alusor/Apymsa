...
[System.Serializable]
public class Wheel_OptionsEnemy
{
...
[System.Serializable]
public class Transmission_Options_Enemy
{
	public float GearAcceleration = 0.0f;
	public float GearMaxSpeed = 0.0f;
}

public class SimpleEnemyControlVehicle : MonoBehaviour {
	...
	// Assign the velocity to the regidbody2D of the vehicle. // Para avanzar
